...
def _detect_ob_region(im_frame, im_ob_tmp, debug=False):
    ...
    if debug:
        gray.show()
    ob_region = gray.point(lambda x: 0 if x > 125 else 255, '1')
...
def top_songs(net, list_img_origin,
              frame_template,
              list_img_ob, img_txt,
              path_out,
              collum_mode=1,
    ...
    for index, img_ori in enumerate(list_img_origin):
        ...
        old, im, _pred, _pred_blur = get_object(img_ori, net, show_img=debug)
        ...
        im_frame = change(object_img, img_frame, net, pred=_pred_img, pred_blur=_pred_blur,
...
if __name__ == "__main__":
    ...
    list_img_ob = ["./develop_env/new_style/ex1/ob.png"]
    img_txt = "./develop_env/new_style/ex1/text.png"
    frame_template = "./develop_env/new_style/ex1/frame.png"
